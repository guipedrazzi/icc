    ...
    public function paginacao($page, $tot, $max = 10, $funcaoPesquisa = 'pesquisaSimples')
    {
        ...
        if (!$paginacaoUnica) //caso exista mais de uma página
        {
            ...
            if($page == 1) // PESSOA ESTÁ NA PRIMEIRA PÁGINA
            {
                ...
                $mudaPageCima  .= "<li class='active green lighten-2'><a onclick='$funcaoPesquisa(1)'>Primeira</a></li>";
                $mudaPageBaixo .= "<li class='active green lighten-2'><a onclick='$funcaoPesquisa(1)'>Primeira</a></li>";
            ...
            else if($page == $paginas) //PESSOA ESTÁ NA ULTIMA PÁGINA
            {
                ...
                $mudaPageCima  .= "<li class='active green lighten-2'><a onclick='$funcaoPesquisa($paginas)'>Ultima</a></li>";
                $mudaPageBaixo .= "<li class='active green lighten-2'><a onclick='$funcaoPesquisa($paginas)'>Ultima</a></li>";
            }
            else
            {
                //PRIMEIRA PAGINA
                ...
                $mudaPageCima  .= "<li class='active green lighten-2'><a onclick='$funcaoPesquisa($page)'>$page</a></li>";
                $mudaPageBaixo .= "<li class='active green lighten-2'><a onclick='$funcaoPesquisa($page)'>$page</a></li>";
